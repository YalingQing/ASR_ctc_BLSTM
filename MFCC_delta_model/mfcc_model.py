...
class brnn_ctc_mfcc():
    ...
    def _model_init(self):
        ...
        lstm = Bidirectional(LSTM(500, return_sequences=True, activity_regularizer = l2(1e-2), dropout = 0.4), name = "LSTM1")(mask)
        lstm = Bidirectional(LSTM(500, return_sequences=True, activity_regularizer = l2(1e-2), dropout = 0.4), name = "LSTM2")(lstm)
        lstm = Bidirectional(LSTM(500, return_sequences=True, activity_regularizer = l2(1e-2), dropout = 0.4), name = "LSTM3")(lstm)
